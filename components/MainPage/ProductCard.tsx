...
export default function ProductCard({
  ...
  return (
    <div className="carousel-item relative m-10 flex w-full max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100  shadow-md">
      <Link
      ...
      <div className="mt-4 px-5 pb-5">
        <Link href={`/product/${company.trim()}/${name.trim()}`}>
          <h5 className="text-lg text-center tracking-tight ">
            {company.trim()} {name}
          </h5>
